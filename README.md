...
2. Install it using `apt` to automatically fetch dependencies:
    ```bash
    sudo apt install ./GlobalProtect_1.2.6_amd64.deb
    ```
...
2. Install it using `dnf`:
    ```bash
    sudo dnf install ./GlobalProtect-1.2.6-1.x86_64.rpm
    ```
...
2. Make it executable:
    ```bash
    chmod +x GlobalProtect_1.2.6_amd64.AppImage
    ```
3. Run it:
    ```bash
    ./GlobalProtect_1.2.6_amd64.AppImage
    ```
...
---
*v1.2.6 for Linux (x86_64 packages)*
